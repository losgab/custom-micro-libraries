...
static esp_err_t gled_new_strip_rmt_encoder(gled_strip_rmt_device *ret_device)
{
    ...
    gled_strip_rmt_encoder *new_encoder = malloc(sizeof(gled_strip_rmt_encoder));
    ...
    bytes_encoder_config = (rmt_bytes_encoder_config_t){
        .bit0 = {
            .level0 = 1,
            .duration0 = 0.3 * ret_device->rmt_config.resolution_hz / 1000000, // T0H=0.3us
            .level1 = 0,
            .duration1 = 0.9 * ret_device->rmt_config.resolution_hz / 1000000, // T0L=0.9us
        },
        .bit1 = {
            .level0 = 1,
            .duration0 = 0.9 * ret_device->rmt_config.resolution_hz / 1000000, // T1H=0.9us
            .level1 = 0,
            .duration1 = 0.3 * ret_device->rmt_config.resolution_hz / 1000000, // T1L=0.3us
        },
    ...
    ret_device->strip_encoder = new_encoder;
    return ESP_OK;
}
